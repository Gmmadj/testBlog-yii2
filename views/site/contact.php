                    ...
                    <div class="col-lg-6 mb-5 tm-contact-box">
                      <div class="tm-contact-form-wrap">
                        ...
                        <?php $form = ActiveForm::begin([
                                  'id' => 'contact-form',
                                  'options' => ['class' => 'tm-contact-form']
                        ]); ?>

                        <?= $form->field($contactForm, 'name')->textInput(['class' => 'form-control rounded-0 border-top-0 border-right-0 border-left-0',
                        'id' => 'contact_name']) ?>

                        <?= $form->field($contactForm, 'email')->textInput(['class' => 'form-control rounded-0 border-top-0 border-right-0 border-left-0',
                      'id' => 'contact_email']) ?>

                        <?= $form->field($contactForm, 'message')->textArea(['class' => 'form-control rounded-0 border-top-0 border-right-0 border-left-0',
                      'id' => 'contact_message']) ?>

                        <div class="form-group">
                            <?= Html::submitButton('Отправить', ['class' => 'btn rounded-0 d-block ml-auto tm-btn-primary']) ?>
                        </div>
